...
// import java.io.File;
// import com.brainwallet.tools.security.BRKeyStore.aliasObjectMap
...
// import com.brainwallet.presenter.activities.settings.TestActivity
//
// class KeyStoreTests {
...
//            BRKeyStore.resetWalletKeyStore(activity)
//        }
//    }
//
//    @After
...
//        modules(module {
//            single<KeyStoreManager> { mockk(relaxed = true) }
//        })
//    }
//    fun setGetCanary()
//    {
...
//            e.printStackTrace();
//            Assert.fail("setGetCanary threw unexpected UserNotAuthenticatedException: " + e.getMessage());
//        }
...
//
//    @Test
//    fun `set and get phrase, should return correct value as expected`() {
//
//        val phrase =
//            "axis husband project any sea patch drip tip spirit tide bring belt".toByteArray()
//
//        scenario.onActivity { activity ->
//            try {
//                BRKeyStore.putPhrase(phrase, activity, 0)
//            } catch (e: UserNotAuthenticatedException) {
//                Assert.fail("putPhrase threw unexpected UserNotAuthenticatedException: ${e.message}")
//            }
//
//            assertFilesExist(BRKeyStore.PHRASE_ALIAS)
//
//            var freshGet = ByteArray(0)
//            try {
//                freshGet = BRKeyStore.getPhrase(activity, 0) ?: ByteArray(0)
//            } catch (e: UserNotAuthenticatedException) {
//                Assert.fail("getPhrase threw unexpected UserNotAuthenticatedException: ${e.message}")
//            }
//            Assert.assertArrayEquals(phrase, freshGet)
//
//            // Japanese phrase
//            val japanesePhrase =
//                "こせき　ぎじにってい　けっこん　せつぞく　うんどう　ふこう　にっすう　こせい　きさま　なまみ　たきび　はかい".toByteArray()
//
//            try {
//                BRKeyStore.putPhrase(japanesePhrase, activity, 0)
//            } catch (e: UserNotAuthenticatedException) {
//                Assert.fail("putPhrase threw unexpected UserNotAuthenticatedException: ${e.message}")
//            }
//
//            assertFilesExist(BRKeyStore.PHRASE_ALIAS)
//
//            var freshJapGet = ByteArray(0)
//            try {
//                freshJapGet = BRKeyStore.getPhrase(activity, 0) ?: ByteArray(0)
//            } catch (e: UserNotAuthenticatedException) {
//                Assert.fail("getPhrase threw unexpected UserNotAuthenticatedException: ${e.message}")
//            }
//            Assert.assertArrayEquals(japanesePhrase, freshJapGet)
//        }
//    }
//
//    @Test
...
//        Assert.assertArrayEquals(authKey, freshGet);
//    }
//
//    @Test
//    fun setGetWalletCreationTime()
//    {
//        int time = 1479686841;
...
//        Assert.assertEquals(time, freshGet);
//    }
//
//    @Test
//    fun setGetPassCode()
...
//        Assert.assertEquals(passCode, freshGet);
//
//        passCode = "0000";
//        BRKeyStore.putPinCode(passCode, mActivityRule.getActivity());
//        assertFilesExist(BRKeyStore.PASS_CODE_ALIAS);
...
//        Assert.assertEquals(failCount, freshGet);
//    }
//
//    @Test
//    fun setGetSpendLimit()
//    {
...
//        Assert.assertEquals(spendLimit, freshGet);
//    }
//
//    @Test
//    fun  setGetSFailTimeStamp()
//    {
//        val failTime = 1479686841L
...
//        Assert.assertEquals(failTime, freshGet);
//    }
//
//    @Test
//    fun setGetLastPasscodeUsedTime()
//    {
...
//                "axis husband project any sea patch drip tip spirit tide bring belt".getBytes(),
...
//            Assert.fail();
//        }
//        BRKeyStore.putMasterPublicKey(
//            "26wZYDdvpmCrYZeUcxgqd1KquN4o6wXwLomBW5SjnwUqG".getBytes(),
//            mActivityRule.getActivity()
//        );
//        BRKeyStore.putAuthKey(
//            "26wZYDdvpmCrYZeUcxgqd1KquN4o6wXwLomBW5SjnwUqG".getBytes(),
//            mActivityRule.getActivity()
//        );
//        BRKeyStore.putToken(
...
//        try {
//            phrase = BRKeyStore.getPhrase(scenario.onActivity {  activity -> activity
//
//            }, 0);
//        } catch (UserNotAuthenticatedException e) {
//            e.printStackTrace();
...
//
//    @Test
//    fun testKeyStoreAuthTime()
//    {
//        Assert.assertEquals(BRKeyStore.AUTH_DURATION_SEC, 300);
//    }
//
//    @Test
//    fun testKeyStoreAliasMap()
//    {
//        Assert.assertNotNull(aliasObjectMap);
//        Assert.assertEquals(aliasObjectMap.size(), 12);
//    }
//
//    fun assertFilesExist(String alias)
//    {
//        Assert.assertTrue(
//            new File (BRKeyStore.getFilePath(
//                aliasObjectMap.get(alias).datafileName,
//                mActivityRule.getActivity()
//            )).exists()
//        );
//        Assert.assertTrue(
//            new File (BRKeyStore.getFilePath(
//                aliasObjectMap.get(alias).ivFileName,
//                mActivityRule.getActivity()
//            )).exists()
//        );
//    }
...
// //        Thread {
// //            secondSuccess = store!!.syncAllKeys()
// //            latch.countDown()
// //        }.start()
// //        Assert.assertTrue(success)
// //        latch.await(5, TimeUnit.SECONDS)
// //        // note: both assertions on the same variable in the original
// //        // were also logically broken — one must be false
// //        Assert.assertFalse(secondSuccess)
// //    }
// //
// //    @Test
...
// //        Assert.assertEquals(123, mds[0].blockHeight)
// //        Assert.assertEquals(3, mds[0].classVersion)
// //        Assert.assertEquals("hehey !", mds[0].comment)
// //        Assert.assertEquals(21324, mds[0].creationTime)
// //        Assert.assertEquals("someDevice2324", mds[0].deviceId)
// //        Assert.assertEquals(234, mds[0].fee)
// //        Assert.assertEquals(23423, mds[0].txSize)
// //        Assert.assertEquals("curr", mds[0].exchangeCurrency)
// //        Assert.assertEquals(23.4343, mds[0].exchangeRate, 0.0)
// //    }
// //
// //    @Test
