...
JNIEXPORT void JNICALL Java_com_brainwallet_wallet_BRPeerManager_connect(JNIEnv *env, jobject thiz);

JNIEXPORT void JNICALL Java_com_brainwallet_wallet_BRPeerManager_rescan(JNIEnv *env, jobject thiz);

JNIEXPORT void JNICALL
Java_com_brainwallet_wallet_BRPeerManager_putBlock(JNIEnv *env, jobject thiz,
                                                   jbyteArray block, int blockHeight);

JNIEXPORT void JNICALL
Java_com_brainwallet_wallet_BRPeerManager_createBlockArrayWithCount(JNIEnv *env,
                                                                    jobject thiz,
                                                                    jint blockCount);

JNIEXPORT void JNICALL
Java_com_brainwallet_wallet_BRPeerManager_putPeer(JNIEnv *env, jobject thiz,
                                                  jbyteArray peerAddress,
                                                  jbyteArray peerPort,
                                                  jbyteArray peerTimeStamp);

JNIEXPORT void JNICALL
Java_com_brainwallet_wallet_BRPeerManager_createPeerArrayWithCount(JNIEnv *env,
                                                                   jobject thiz,
                                                                   jint peerCount);
...
Java_com_brainwallet_wallet_BRPeerManager_syncProgress(JNIEnv *env, jclass thiz,
                                                       int startHeight);
...
JNIEXPORT void JNICALL Java_com_brainwallet_presenter_activities_IntroActivity_testCore(JNIEnv *env,
                                                                                        jobject instance);
