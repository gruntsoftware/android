...
Java_com_brainwallet_tools_security_LitecoinURIHandler_parsePaymentRequest(JNIEnv *env, jobject obj,
                                                                       jbyteArray payment) {
    ...
    jclass clazz = (*env)->FindClass(env,
                                     "com/brainwallet/presenter/entities/PaymentRequestWrapper");
...
Java_com_brainwallet_tools_security_LitecoinURIHandler_getCertificatesFromPaymentRequest(JNIEnv *env,
                                                                                     jobject obj,
                                                                                     jbyteArray payment,
                                                                                     jint index) {
...
Java_com_brainwallet_tools_security_LitecoinURIHandler_parsePaymentACK(JNIEnv *env, jobject obj,
