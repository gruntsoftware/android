...
Java_com_brainwallet_tools_security_BitcoinUrlHandler_parsePaymentRequest(JNIEnv *env, jobject obj,
                                                                       jbyteArray payment) {
...
Java_com_brainwallet_tools_security_BitcoinUrlHandler_getCertificatesFromPaymentRequest(JNIEnv *env,
                                                                                     jobject obj,
                                                                                     jbyteArray payment,
                                                                                     jint index) {
...
Java_com_brainwallet_tools_security_BitcoinUrlHandler_parsePaymentACK(JNIEnv *env, jobject obj,
