...
import com.brainwallet.presenter.fragments.FragmentPhraseWord;
...
public class PaperKeyActivity extends BRActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (cleanPhrase.charAt(cleanPhrase.length() - 1) == '\0') {
            ...
            IllegalArgumentException ex = new IllegalArgumentException("Paper Key error, please contact support at support.brainwallet.co: " + wordArray.length);
            Timber.e(ex);
            throw ex;
        } else {
    ...
    private void setButtonEnabled(boolean b) {
        previousButton.setTextColor(getColor(b ? R.color.white : R.color.white));
