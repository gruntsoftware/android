...
import com.brainwallet.data.repository.SelectedPeersRepository.Companion.LITECOIN_NODES_URL
...
@Single(binds = [SelectedPeersRepository::class])
class SelectedPeersRepositoryImpl(
