...
fun interface NotificationHandlerBuilderProvider {
    fun createNotificationBuilder(context: Context, channelId: String): NotificationCompat.Builder
}

fun interface NotificationNotifier {
    fun notify(context: Context, notificationBuilder: NotificationCompat.Builder)
}

@Single
@SuppressLint("MissingPermission")
class NotificationHandler(
    private val notificationBuilderProvider: NotificationHandlerBuilderProvider =
        NotificationHandlerBuilderProvider { context, channelId ->
            NotificationCompat.Builder(context, channelId)
        },
    private val notificationNotifier: NotificationNotifier = NotificationNotifier { context, notificationBuilder ->
    ...
    fun handleMessageReceived(context: Context, remoteMessage: RemoteMessage): Boolean {
        ...
        val notification = notificationBuilderProvider.createNotificationBuilder(context, channelId)
        ...
        notificationNotifier.notify(context, notification)
