...
fun SetPasscodeConfirmScreen(
    digits: List<Int>,
    onEvent: (SetPasscodeConfirmScreenEvent) -> Unit = {},
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                ...
                navigationIcon = {
                    IconButton(
                        onClick = { onEvent.invoke(SetPasscodeConfirmScreenEvent.OnBackClick) },
                    ) {
                        Icon(
        ...
        Column(
            ...
            LargeButton(
                onClick = {
                    onEvent.invoke(SetPasscodeConfirmScreenEvent.OnConfirmClick)
                },
            ) {
                Text(
                    text = stringResource(R.string.setup_app_passcode),
