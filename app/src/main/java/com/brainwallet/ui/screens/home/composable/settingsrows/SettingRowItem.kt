...
import com.brainwallet.ui.theme.BWColors
...
fun SettingRowItemExpandable(
    ...
    Column(
        modifier = modifier.background(DesignTheme.colors.settingRowItemBackground(expanded))
    ) {
...
fun BWColors.settingRowItemBackground(
