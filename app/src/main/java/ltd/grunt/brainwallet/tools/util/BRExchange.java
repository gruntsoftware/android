...
import static ltd.grunt.brainwallet.tools.util.BRConstants.CURRENT_UNIT_PHOTONS;
import static ltd.grunt.brainwallet.tools.util.BRConstants.ROUNDING_MODE;
