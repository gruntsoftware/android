package ltd.grunt.brainwallet.tools.qrcode;

import android.graphics.Point;
import android.graphics.PointF;

import ltd.grunt.brainwallet.tools.qrcode.QRCodeReaderView;
import com.google.zxing.ResultPoint;

public class QRToViewPointTransformer {

  public PointF[] transform(ResultPoint[] qrPoints, boolean isMirrorPreview,
                            ltd.grunt.brainwallet.tools.qrcode.QRCodeReaderView.Orientation orientation,
  ...
  public PointF transform(ResultPoint qrPoint, boolean isMirrorPreview, ltd.grunt.brainwallet.tools.qrcode.QRCodeReaderView.Orientation orientation,
                          Point viewSize, Point cameraPreviewSize) {
    ...
    if (orientation == ltd.grunt.brainwallet.tools.qrcode.QRCodeReaderView.Orientation.PORTRAIT) {
