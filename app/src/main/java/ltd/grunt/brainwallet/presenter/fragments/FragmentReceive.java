package ltd.grunt.brainwallet.presenter.fragments;

import static ltd.grunt.brainwallet.tools.animation.BRAnimator.animateBackgroundDim;
import static ltd.grunt.brainwallet.tools.animation.BRAnimator.animateSignalSlide;
...
import ltd.grunt.brainwallet.presenter.customviews.BRButton;
import ltd.grunt.brainwallet.presenter.customviews.BRKeyboard;
import ltd.grunt.brainwallet.presenter.customviews.BRLinearLayoutWithCaret;
import ltd.grunt.brainwallet.tools.animation.BRAnimator;
import ltd.grunt.brainwallet.tools.animation.SlideDetector;
import ltd.grunt.brainwallet.tools.manager.AnalyticsManager;
import ltd.grunt.brainwallet.tools.manager.BRClipboardManager;
import ltd.grunt.brainwallet.tools.manager.BRSharedPrefs;
import ltd.grunt.brainwallet.tools.qrcode.QRUtils;
