...
import ltd.grunt.brainwallet.presenter.entities.Partner;
...
class BuyPartnersAdapter extends RecyclerView.Adapter<BuyPartnersAdapter.PartnerViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final PartnerViewHolder holder, int position) {
        ...
        if (partner.getCode() == ltd.grunt.brainwallet.presenter.fragments.FragmentBuy.Partner.BITREFILL) {
        ...
        holder.buyPartnerWrapper.setOnClickListener(v -> {
            ...
            if (partner.getCode() == ltd.grunt.brainwallet.presenter.fragments.FragmentBuy.Partner.MOONPAY) {
